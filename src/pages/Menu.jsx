...
const url_gambar = "http://localhost:3000/";
const Menu = () => {
      ...
      <div className="p-8 my-20 bg-white">
        <div className="flex flex-col md:flex-row mb-8">
          <div className="md:w-1/2 w-full mb-8 md:mb-0 flex flex-col items-center">
            <img src={MenuImage} alt="Menu" className="w-full h-auto md:w-3/4" style={{ height: "auto" }} />
          </div>

          <div className="flex flex-col w-full md:w-1/2">
            <div className="mb-8">
              <h2 className="font-bold mb-4" style={{ color: "#FF7517", fontSize: "40px" }}>
                Makanan
              </h2>
              {listMenu
                ...
                .map((item) => (
                  <div key={item.id_menu} className="flex items-center mb-4">
                    <img src={`${url_gambar}${item.gambar}`} alt="Dish" className="w-16 h-16 rounded-full mr-4" />
