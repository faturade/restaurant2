    ...
    <div> 
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-gray-100 min-h-screen p-6">
        ...
        <div className="flex flex-1 justify-center p-6">
          <img src={aboutImage} alt="About Us" style={{ maxWidth: '100%', height: '350px', borderTopRightRadius: '25%' }} />
          <div className="absolute transform translate-x-10 translate-y-10 bg-white p-4 shadow-lg w-3/4 max-w-xs text-center flex flex-col items-center" style={{ bottom: '-10rem', right: '25rem' }}>
      ...
      <div className='bg-cover bg-center w-full max-h-96 p-8' style={{ backgroundImage: `url(${aboutImage})`, position: 'relative',  backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
